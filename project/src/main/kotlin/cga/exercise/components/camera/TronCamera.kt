...
class TronCamera(parent : Transformable? = Transformable(), val fov: Float = Math.toRadians(90.0f), val ratio : Float = (16f/9f), val near : Float = 0.1f, val far : Float = 100.0f): ICamera, Transformable(parent = parent) {
